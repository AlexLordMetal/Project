namespace ServicesApp.Website.HelpClasses
{
    public static class ManageMessage
    {
        ...
        public const string AddServiceRelationSuccess = "Your service relation has been created.";
        ...
        public const string ServiceRelationExists = "Your service relation already exists.";
    }
}